<?php /* Smarty version 2.6.26, created on 2019-02-11 23:10:11
...
/index.php/crm/CstLinkman/cst_linkman_json/';
...
/index.php/crm/CstLinkman/cst_linkman_modify_recommend/";
		}else if(batch_act=="del"){
			act_url="<?php echo @ACT; ?>
/index.php/crm/CstLinkman/cst_linkman_del/";
		}
...
/index.php/crm/CstLinkman/cst_linkman_modify/linkman_id/'+linkman_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
