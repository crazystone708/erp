<?php /* Smarty version 2.6.26, created on 2019-02-11 23:11:43
         compiled from goods/goods_brand_show.html */ ?>
<!DOCTYPE html>
<html>
...
/goods/GoodsBrand/goods_brand_add/" >
...
/goods/GoodsBrand/goods_brand_modify/brand_id/<%=list[i]['brand_id']%>/">修改</a> 
			   <a href="<?php echo @ACT; ?>
/goods/GoodsBrand/goods_brand_del/brand_id/<%=list[i]['brand_id']%>/">删除</a>
		</td>
	</tr>
<% } %>
</script>
...
/index.php/goods/GoodsBrand/goods_brand_json/';
$(document).ready(function () {
	...
	$("body").on("click", ".onoffswitch-checkbox", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo @ACT; ?>
/index.php/goods/GoodsBrand/goods_brand_modify_recommend/",
...
function brand_sort(obj,brand_id){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo @ACT; ?>
/index.php/goods/GoodsBrand/goods_brand_modify_sort/",
