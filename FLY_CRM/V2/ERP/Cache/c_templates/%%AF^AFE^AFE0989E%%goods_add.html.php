<?php /* Smarty version 2.6.26, created on 2019-02-11 23:10:31
         compiled from goods/goods_add.html */ ?>
<!DOCTYPE html>
<html>
...
/goods/Goods/goods_add/">
            <div class="tabs-container">
              <ul class="nav nav-tabs">
                ...
                <li class=""><a data-toggle="tab" href="#tab-5" aria-expanded="false">商品规格</a> </li>
              </ul>
                ...
                <div id="tab-1" class="tab-pane active">
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input name="goods_name" class="form-control" type="text" placeholder="请输入商品的名称" required/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">商品分类：</label>
                      <div class="col-sm-10"> <?php echo $this->_tpl_vars['goods_category_select']; ?>
 </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">商品品牌：</label>
                      <div class="col-sm-8">
                        <input name="attr_name" class="form-control" type="text" placeholder="请输入属性类型名称" required/>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">商品关键字：</label>
                      <div class="col-sm-10">
                        <input name="keywords" class="form-control" type="text" placeholder="请输入属性类型名称" required/>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input name="market_price" class="form-control" type="digits" value="<?php echo $this->_tpl_vars['one']['market_price']; ?>
" placeholder="商品市场价格"/>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input name="sale_price" class="form-control" type="digits" value="<?php echo $this->_tpl_vars['one']['sale_price']; ?>
" placeholder="商品销售价格"/>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input name="cost_price" class="form-control" type="digits" value="<?php echo $this->_tpl_vars['one']['cost_price']; ?>
" placeholder="商品成本价格"/>
                      </div>
                    </div>
                    <div class="form-group">
...
" placeholder="排序号"/>
                ...
                <div id="tab-3" class="tab-pane">
                  <div class="imgupload">
                    ...
                    <div class="actbtn"> <img src="<?php echo @APP; ?>
/View/template/img/webuploader.png" onClick="javascript:imgupload('imglist');"> </div>
                  </div>
                </div>
				  		<div id="tab-4" class="tab-pane">4444</div>
				  		<div id="tab-5" class="tab-pane">
							...
							<div class="ibox-content">
								批量设置： 
								<a href="javascript:void(0);" class="batch_modify_sale">销售价格</a>&nbsp;&nbsp;
								<a href="javascript:void(0);" class="batch_modify_market">市场价格</a> &nbsp;&nbsp;
								<a href="javascript:void(0);" class="batch_modify_cost">成本价格</a>&nbsp;&nbsp;  
								<a href="javascript:void(0);" class="batch_modify_stock">库存</a> &nbsp;&nbsp;
							</div>
				  			<div class="ibox-content" id="create_spec_show"></div>
				  		</div>
              </div>
            </div>
            <div class="panel-body">
...
$(document).ready(function () {
	...
	ue.ready(function() {
		ue.setContent('<?php echo $this->_tpl_vars['one']['content']; ?>
');  //赋值给UEditor
	});
	//编辑规格
...
/goods/GoodsSpec/goods_spec_create/create_id/create_spec_show/'//iframe的url
		});	
	});
	layer.config({
		path: '<?php echo @APP; ?>
/View/template/js/plugins/layer/', //layer.js所在的目录，可以是绝对目录，也可以是相对目录
...
function imgupload(imgs_id){
	layer.open({
		...
		area: ['90%', '90%'],
		content: '<?php echo @ACT; ?>
/Upload/upload_img/imgs_id/'+imgs_id //iframe的url
	});		
}
